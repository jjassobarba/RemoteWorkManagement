...
namespace ReminderService
{
    public class SendNotification
    {
        ...
        public static bool MailSender(string mailto, string fieldValue, EmailType type)
        {
            ...
            try
            {
                var smtp = new SmtpClient(System.Configuration.ConfigurationSettings.AppSettings["smtpServer"],
                    Convert.ToInt32(System.Configuration.ConfigurationSettings.AppSettings["smtpPort"]))
                {
                    EnableSsl = true,
                    UseDefaultCredentials = false,
                    Credentials =
                        new NetworkCredential(System.Configuration.ConfigurationSettings.AppSettings["emailAccount"],
                            System.Configuration.ConfigurationSettings.AppSettings["emailPassword"])
                };
                var bodyMessage = CheckEmailTemplate(type, fieldValue);
                var mail = new MailMessage(System.Configuration.ConfigurationSettings.AppSettings["emailAccount"], mailto,
